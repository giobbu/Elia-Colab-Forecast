...
def compute_forecasters_contributions(buyer_resource_name, ens_params, y_test, previous_day_forecast_range):
    ...
    results_contributions = calculate_contributions(results_challenge_dict, ens_params, y_test, previous_day_forecast_range)
